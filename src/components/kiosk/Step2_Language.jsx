...
export const Step2_Language = () => {
  ...
  const handleLanguageSelect = (langCode) => {
    ...
    const audioSample = {
      en: 'You have selected English. MediKiosk will assist you in English.',
      hi: 'आपने हिन्दी भाषा का चयन किया है। मेडीकियोस्क आपका स्वागत करता है।',
      te: 'మీరు తెలుగు భాషను ఎంచుకున్నారు. మెడికియోస్క్ మీకు సహాయం చేస్తుంది.',
      ta: 'நீங்கள் தமிழ் மொழியைத் தேர்ந்தெடுத்துள்ளீர்கள். மெடிகியோஸ்க் உங்களை வரவேற்கிறது.',
      mr: 'तुम्ही मराठी भाषा निवडली आहे. मेडीकिओस्क तुमचे स्वागत करते.',
      bn: 'আপনি বাংলা ভাষা নির্বাচন করেছেন। মেডিকিয়স্কে আপনাকে স্বাগতম।'
    };
